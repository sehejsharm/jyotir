...
export const expansionQuestions = [
  // Topic 1: GDP, Business Cycles & Economic Indicators (q01-q08)
  {
    ...
    optionB: "Intermediate goods purchased by manufacturers",
    optionC: "Gross private domestic investment",
    optionD: "Net exports of goods and services",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "includes only goods, not services",
    optionB: "is adjusted for changes in the price level",
  ...
  },
  {
    ...
    optionC: "Consumer price index",
    optionD: "Stock market index",
    correctOption: "C",
  ...
  },
  {
    ...
    optionA: "high unemployment and rising inventory",
    optionB: "low output and falling business confidence",
    optionC: "maximum output and emerging inflationary pressure",
  ...
  },
  {
    ...
    optionB: "decrease because the private sector is more efficient",
    optionC: "remain unchanged, as the two changes offset each other",
  ...
  // Topic 2: Monetary & Fiscal Policy (q01-q08)
  {
    ...
    optionA: "contractionary monetary policy",
    optionB: "contractionary fiscal policy",
    optionC: "expansionary monetary policy",
  ...
  },
  {
    ...
    optionB: "a 5% decrease in velocity",
    optionC: "a 5% increase in the price level",
  ...
  },
  {
    ...
    optionA: "require legislative approval before taking effect",
    optionB: "act counter-cyclically without new government decisions",
  ...
  },
  {
    ...
    optionB: "higher real interest rates and an appreciating currency",
    optionC: "lower inflation and a depreciating currency",
  ...
  },
  {
    ...
    optionC: "lower and more stable long-run inflation",
    optionD: "faster economic growth in every cycle",
    correctOption: "C",
  ...
  },
  {
    ...
    optionC: "closest to zero",
    optionD: "closest to one",
    correctOption: "D",
  ...
  },
  {
    ...
    optionB: "the interest rate differential between the two countries",
    optionC: "the trade balance difference between the two economies",
  ...
  },
  {
    ...
    optionC: "Foreign direct investment inflows to domestic firms",
    optionD: "Unilateral transfer payments to foreign governments",
    correctOption: "C",
  ...
  },
  {
    ...
    optionA: "applies only to currency swap transactions",
    optionB: "is for immediate or near-immediate currency delivery",
  ...
  },
  {
    ...
    optionC: "raise the domestic price and protect domestic producers",
    optionD: "increase total economic welfare in the importing country",
    correctOption: "C",
  ...
  },
  {
    ...
    optionC: "USD, US Treasuries, and gold",
    optionD: "Small-cap domestic growth stocks",
    correctOption: "C",
  ...
  },
  {
    ...
    optionA: "elimination of all foreign direct investment",
    optionB: "trade liberalisation under multilateral agreements and declining transport costs",
  ...
  },
  {
    ...
    optionB: "additional systematic and unsystematic risks unique to that market",
    optionC: "lower corporate tax rates in emerging markets",
  ...
  },
  {
    ...
    optionB: "pure cost efficiency to resilience and security",
    optionC: "domestic markets to global expansion",
    optionD: "labour-intensive to capital-intensive production",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "in proportion to the stage of completion each period",
    optionC: "when all costs have been incurred and recovered",
    optionD: "equally across all periods regardless of progress",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "lower near-term revenues and higher accounts payable",
    optionB: "inflated near-term earnings and higher accounts receivable",
  ...
  },
  {
    ...
    optionA: "net income before preferred dividends",
    optionB: "gross profit minus depreciation only",
    optionC: "earnings before interest and taxes from core operations",
  ...
  },
  {
    ...
    optionB: "defer all revenue until the support period is complete",
    optionC: "identify two performance obligations and allocate the price to each",
  ...
  },
  {
    ...
    optionB: "bypass the income statement and affect equity directly",
    optionC: "are recorded as long-term liabilities on the balance sheet",
    optionD: "arise only from dividend payments to shareholders",
    correctOption: "B",
  ...
  },
  {
    ...
    optionC: "repurchased by the company and not yet retired",
    optionD: "converted from preferred into common stock",
    correctOption: "C",
  ...
  },
  {
    ...
    optionB: "Increasing order of liquidity (least liquid first) or decreasing, both permitted",
    optionC: "Only alphabetical order is acceptable",
  ...
  },
  {
    ...
    optionA: "values the firm more than its recorded net assets",
    optionB: "believes the firm's assets are worth less than their book value",
  ...
  },
  {
    ...
    optionA: "Accounts payable due in 30 days",
    optionB: "Accrued wages payable in the current period",
    optionC: "Defined benefit pension obligation",
  ...
  },
  {
    ...
    optionA: "cash held by the company in its bank account",
    optionB: "the cumulative net income earned less dividends paid over time",
  ...
  },
  {
    ...
    optionB: "the company acquires another firm for more than the fair value of net identifiable assets",
    optionC: "the company internally develops patents and trademarks",
  ...
  // Topic 7: Cash Flow Statement & FCF Analysis (q01-q08)
  {
    ...
    optionA: "it represents a cash inflow from asset disposals",
    optionB: "it is a non-cash charge that reduced net income but did not use cash",
  ...
  },
  {
    ...
    optionC: "CFO minus capex plus net borrowing",
    optionD: "FCFF minus interest expense",
    correctOption: "C",
  ...
  },
  {
    ...
    optionD: "Supplemental non-cash disclosures",
    correctOption: "C",
  ...
  },
  {
    ...
    optionB: "cash available to all capital providers before financing costs",
    optionC: "operating income after taxes but before depreciation",
    optionD: "net income adjusted for non-cash working capital changes",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "a subtraction from net income, as cash has not yet been collected",
    optionC: "a financing inflow, reflecting customer credit extended",
    optionD: "a non-cash investing activity disclosed in supplemental notes",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "starts with net income and adjusts for non-cash items",
    optionB: "shows actual cash received from customers and paid to suppliers",
  ...
  },
  {
    ...
    optionB: "inventory balance on the balance sheet",
    optionC: "total debt on the balance sheet",
    optionD: "accumulated depreciation on PP&E",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "(Cost - Salvage value) divided by useful life",
    optionC: "Cost multiplied by the declining balance rate",
  ...
  },
  {
    ...
    optionA: "taxable income exceeds book income, so taxes are paid early",
    optionB: "book income exceeds taxable income, creating a future tax obligation",
  ...
  },
  {
    ...
    optionB: "reverse the write-down up to the original carrying amount",
    optionC: "write up inventory to any market value regardless of cost",
  ...
  },
  {
    ...
    optionB: "recognises warranty expense for book purposes before it is deductible for taxes",
    optionC: "recognises revenue earlier for book purposes than for tax purposes",
    optionD: "capitalises an expense for book purposes that is immediately expensed for tax",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "revalue assets downward only, never upward",
    optionB: "revalue assets to fair value, with gains going to other comprehensive income",
