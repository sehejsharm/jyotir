...
export const expansionQuestions = [
  ...
  },
  {
    ...
    optionB: "Volatility of the underlying asset",
    optionC: "Historical dividend growth rate",
  ...
  },
  {
    ...
    optionB: "The volatility backed out of a market option price using the pricing model",
    optionC: "The realized volatility over the option's life",
    optionD: "The GARCH forecast of future volatility",
    correctOption: "B",
  ...
  },
  {
    ...
    optionC: "Implied volatility varies with the strike price, violating strict Black-Scholes assumptions",
    optionD: "Options are priced using the CAPM",
    correctOption: "C",
  ...
  },
  {
    ...
    optionC: "Unlimited liability if the asset price falls",
    optionD: "The right to buy the asset at the strike price",
    correctOption: "D",
  ...
  },
  {
    ...
    optionA: "Returns follow a uniform distribution",
    optionB: "Returns follow a lognormal distribution with constant volatility",
  ...
  // Topic 2: Swaps & Interest Rate Products
  {
    ...
    optionB: "Pays fixed and receives floating",
    optionC: "Pays both fixed and floating rates",
    optionD: "Receives fixed and pays no floating",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "SOFR is based on actual overnight repo transactions, making it more robust",
    optionB: "SOFR is a forward-looking term rate like LIBOR",
    optionC: "SOFR is published by commercial banks, not central banks",
    optionD: "SOFR includes a credit-risk premium like LIBOR",
    correctOption: "A",
  ...
  },
  {
    ...
    optionB: "A fixed-rate bond and a floating-rate bond",
    optionC: "A forward contract and a futures contract",
  ...
  },
  {
    ...
    optionB: "The floating rate is fixed at initiation",
    optionC: "Both legs are denominated in the same currency and netting reduces credit exposure",
  ...
  },
  {
    ...
    optionB: "Involves exchange of principal in different currencies at maturity",
    optionC: "Always uses the same reference rate on both legs",
    optionD: "Cannot be used to hedge foreign exchange risk",
    correctOption: "B",
  ...
  // Topic 3: Fixed Income & Bond Markets
  {
    ...
    optionB: "Equates the bond's price to the present value of its future cash flows",
    optionC: "Measures only the credit spread over the risk-free rate",
    optionD: "Is always equal to the risk-free rate",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "Dollar change in bond price for a 1% change in yield",
    optionB: "Percentage change in bond price per 1% change in yield",
  ...
  },
  {
    ...
    optionB: "The curvature in the price-yield relationship",
    optionC: "The linear sensitivity to rate moves",
  ...
  },
  {
    ...
    optionB: "The discount applied to collateral value to protect the cash lender",
    optionC: "The coupon rate of the collateral bond",
    optionD: "The duration of the collateral",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "Fund their bond holdings with short-term borrowing",
    optionC: "Hedge equity market risk",
  ...
  // Topic 4: Credit Derivatives & Structured Products
  {
    ...
    optionA: "Receives a periodic spread and pays on a credit event",
    optionB: "Pays a periodic spread and receives compensation on a credit event",
  ...
  },
  {
    ...
    optionA: "Lower perceived default risk",
    optionB: "A higher recovery rate",
    optionC: "Higher perceived default risk or lower recovery expectations",
  ...
  },
  {
    ...
    optionB: "Mezzanine tranche",
    optionC: "Equity (first-loss) tranche",
  ...
  },
  {
    ...
    optionA: "Always holds physical bonds as collateral",
    optionB: "Gains credit exposure through CDS rather than actual bond holdings",
  ...
  },
  {
    ...
    optionB: "Has the highest correlation risk",
    optionC: "Has the highest priority claim and the lowest default risk",
  ...
  },
  {
    ...
    optionC: "Default or restructuring of the reference entity",
    optionD: "A decline in commodity prices",
    correctOption: "C",
  ...
  },
  {
    ...
    optionA: "The protection buyer pays more than the expected loss",
    optionB: "The present value of premium payments equals the present value of expected loss payments",
  ...
  },
  {
    ...
    optionB: "Yield curve shape risk arising from non-parallel shifts",
    optionC: "Credit spread movements",
    optionD: "Currency risk in foreign bonds",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "Increase the bond's yield above its YTM",
    optionB: "Enable fair comparison with bullet bonds",
  ...
  },
  {
    ...
    optionA: "The DV01 of the largest position only",
    optionB: "The average DV01 across all positions",
    optionC: "The sum of DV01 across all positions",
  ...
  },
  {
    ...
    optionB: "The cost of the call option embedded in the bond",
    optionC: "Higher liquidity of the callable bond",
    optionD: "A steeper yield curve",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "Key rate durations sum to the total modified duration",
    optionC: "Key rate durations are independent of position size",
  ...
  },
  {
    ...
    optionC: "Fall, because the discount rate applied to the bond's cash flows increases",
    optionD: "Rise proportionally to the spread widening",
    correctOption: "C",
  ...
  // Topic 6: Option Valuation & Greeks
  {
    ...
    optionA: "Always negative",
    optionB: "Between 0 and 1",
  ...
  },
  {
    ...
    optionC: "At-the-money and near expiry",
    optionD: "In-the-money with long time to expiry",
    correctOption: "C",
  ...
  },
  {
    ...
    optionB: "Zero for all options",
    optionC: "Negative, reflecting time decay as expiry approaches",
  ...
  },
  {
    ...
    optionA: "Rho changes with the risk-free rate daily",
    optionB: "Vega increases as options approach expiry",
    optionC: "Delta changes as the underlying price moves, driven by gamma",
  ...
  },
  {
    ...
    optionA: "Low realized volatility and stable markets",
    optionB: "Large moves in the underlying asset in either direction",
  ...
  },
  {
    ...
    optionB: "Discrete rebalancing, transaction costs, and price jumps leave residual risk",
    optionC: "It eliminates all gamma and vega risk simultaneously",
  ...
  // Topic 7: Stress Testing & Scenario Analysis
  {
    ...
    optionB: "Examine portfolio performance under severe scenarios that statistical models may miss",
    optionC: "Calculate expected losses under average market conditions",
    optionD: "Set individual trader position limits",
    correctOption: "B",
  ...
  },
  {
    ...
    optionA: "Diversified Fixed-Asset Stress Test",
    optionB: "Dodd-Frank Act Stress Test",
  ...
  },
  {
    ...
    optionA: "Is too expensive to implement",
    optionB: "Requires Monte Carlo simulation",
    optionC: "Cannot project capital adequacy",
    optionD: "Only captures risks that materialized in the past, missing novel scenarios",
    correctOption: "D",
  ...
  },
  {
    ...
    optionA: "Operational risk event counts",
    optionB: "Market liquidity of trading books",
    optionC: "Capital planning processes and capital adequacy under stress",
  ...
  },
  {
    ...
    optionB: "VaR captures tail severity while stress testing captures frequency",
    optionC: "Stress tests explore specific extreme scenarios while VaR summarizes typical loss distributions",
  ...
  },
  {
    ...
    optionB: "Validation must be independent of model development",
    optionC: "Validation is only required for market risk models",
    optionD: "Validation need not assess model conceptual soundness",
    correctOption: "B",
  ...
  },
  {
    ...
    optionB: "A reporting (output) component",
    optionC: "A stress testing module",
  ...
  },
  {
    ...
    optionB: "Comparing the model's output to those of alternative or industry-standard models",
    optionC: "Counting VaR exceptions over a historical period",
    optionD: "Documenting the model's assumptions for regulators",
    correctOption: "B",
